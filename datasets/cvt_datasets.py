...
def get_args():
    ...
    parser.add_argument('--dst', type=str, default='/public/datasets/VOS/pretrain')
    parser.add_argument('--palette', type=str, default='./mask_palette.png')
...
def create_COCO_img_mask(data):
    ...
    if obj_cnt > 1:
        ...
        img_path_src = os.path.join(args.src, 'images', tmp[0], tmp[1])
...
if __name__ == '__main__':
    ...
    # --name MSRA10K --src /public/datasets/MSRA
    ...
    # --name ECSSD --src /public/datasets/ECSSD
    if args.name == 'ECSSD':
        cvt_ECSSD()
    ...
    # --name PASCAL-S --src /public/datasets/PASCAL-S
    ...
    # --name COCO --src /public/datasets/coco
    if args.name == 'COCO':
        cvt_COCO()
    ...
    # --name PASCALVOC2012 --src /public/datasets/VOCdevkit/VOC2012/
